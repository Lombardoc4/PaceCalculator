...
const result = {
    mile: document.getElementById("res-miles"),
    kilo: document.getElementById("res-kilo")
};
...
const swapUnits = () => {
    ...
    const paceRes = [...document.querySelectorAll('.pace')];

    // Swap on the ui
    (document.getElementById('dis-units')).innerHTML = unitUpdate;
    (document.getElementById('dis-units-secondary')).innerHTML = units;
    (document.getElementById('result')).classList.toggle('swap');
...
(document.getElementById('unit-swap')).addEventListener('click', swapUnits)
